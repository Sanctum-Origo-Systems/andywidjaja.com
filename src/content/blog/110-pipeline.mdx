...
*\* code: [github.com/Sanctum-Origo-Systems/autoloop](https://github.com/Sanctum-Origo-Systems/autoloop). Next post: I'll explain why the observer and the builder are separate instances.\**
